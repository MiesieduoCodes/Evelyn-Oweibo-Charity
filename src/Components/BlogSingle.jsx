...
const BlogSingle = () => {
  ...
  <ul className="flex space-x-4 mb-4">
    <li className="text-blue-500">Charities</li>
    <li className="text-blue-500">Missionary</li>
    <li className="text-blue-500">School</li>
    <li className="text-blue-500">Donation</li>
    <li className="text-blue-500">Children</li>
    <li className="text-blue-500">Africa</li>
  </ul>
